...
(function ($) {
    $.extend({
        ...
        operate: {
            ...
            successTabCallback: function(result) {
                if (result.code == web_status.SUCCESS) {
    	            ...
    	            var $contentWindow = $('.Read_iframe[data-id="' + currentId + '"]', topWindow)[0].contentWindow;
    	            $.modal.close();
    	...
    	common: {
			...
			//提示框tooltip带超链功能
			linkTip: function (id, value, cls, length) {
				...
				let _id = $.common.isEmpty(id) ? "0" : id;
				let _cls = $.common.isEmpty(cls) ? "" : cls;
				let str = "<a href='#' data-id='%s' class='tooltip-show %s' data-toggle='tooltip' title='%s'>%s</a>";
				return $.common.sprintf(str, _id, _cls, _value, _text);
			}
        }
    });
})(jQuery);
