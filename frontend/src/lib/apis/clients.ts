...
export default class ClientsApi {
    static async accessList(): Promise<IAccessListResponse | Error> {
        return await fetch(`/api/v1/access/list`, {
            method: 'GET',
        }).then(async (res) => {
            if (res.status === 200) {
                return res.json();
    ...
    static async accessSet(accesssetrequest: IAccessSetRequest): Promise<number | string[] | Error> {
        ...
        return await fetch(`/api/v1/access/set`, {
            method: 'POST',
            headers: {
    ...
    static async clientsAdd(client: IClient): Promise<number | string[] | Error> {
        ...
        return await fetch(`/api/v1/clients/add`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    static async clientsDelete(clientdelete: IClientDelete): Promise<number | string[] | Error> {
        ...
        return await fetch(`/api/v1/clients/delete`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    static async clientsFind(ip0?: string): Promise<IClientsFindEntry[] | Error> {
        ...
        return await fetch(`/api/v1/clients/find?${qs.stringify(queryParams, { arrayFormat: 'comma' })}`, {
            method: 'GET',
        }).then(async (res) => {
            if (res.status === 200) {
                return res.json();
    ...
    static async clientsStatus(): Promise<IClients | Error> {
        return await fetch(`/api/v1/clients`, {
            method: 'GET',
        }).then(async (res) => {
            if (res.status === 200) {
                return res.json();
    ...
    static async clientsUpdate(clientupdate: IClientUpdate): Promise<number | string[] | Error> {
        ...
        return await fetch(`/api/v1/clients/update`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
