...
export default class GlobalApi {
    static async beginUpdate(): Promise<number | Error> {
        return await fetch(`/api/v1/update`, {
            method: 'POST',
        }).then(async (res) => {
            if (res.status === 200) {
                return res.status;
    ...
    static async dnsConfig(dnsconfig: IDNSConfig): Promise<number | string[] | Error> {
        ...
        return await fetch(`/api/v1/dns_config`, {
            method: 'POST',
            headers: {
    ...
    static async dnsInfo(): Promise<any | Error> {
        return await fetch(`/api/v1/dns_info`, {
            method: 'GET',
        }).then(async (res) => {
            if (res.status === 200) {
                return res.json();
    ...
    static async getVersionJson(getversionrequest: IGetVersionRequest): Promise<IVersionInfo | string[] | Error> {
        ...
        return await fetch(`/api/v1/version.json`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    static async testUpstreamDNS(upstreamsconfig: IUpstreamsConfig): Promise<IUpstreamsConfigResponse | string[] | Error> {
        ...
        return await fetch(`/api/v1/test_upstream_dns`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
