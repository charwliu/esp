...
export default class DNSConfig {
    ...
    readonly _cache_optimistic: boolean | undefined;

    get cacheOptimistic(): boolean | undefined {
        return this._cache_optimistic;
    }
    ...
    readonly _disable_ipv6: boolean | undefined;

    get disableIpv6(): boolean | undefined {
        return this._disable_ipv6;
    }
    ...
    readonly _local_ptr_upstreams: string[] | undefined;
     ...
     */
    get localPtrUpstreams(): string[] | undefined {
        return this._local_ptr_upstreams;
    }
    ...
    readonly _resolve_clients: boolean | undefined;

    get resolveClients(): boolean | undefined {
        return this._resolve_clients;
    }
    ...
    readonly _use_private_ptr_resolvers: boolean | undefined;

    get usePrivatePtrResolvers(): boolean | undefined {
        return this._use_private_ptr_resolvers;
    }
    ...
    constructor(props: IDNSConfig) {
        ...
        if (typeof props.cache_optimistic === 'boolean') {
            this._cache_optimistic = props.cache_optimistic;
        }
        ...
        if (typeof props.disable_ipv6 === 'boolean') {
            this._disable_ipv6 = props.disable_ipv6;
        }
        ...
        if (props.local_ptr_upstreams) {
            this._local_ptr_upstreams = props.local_ptr_upstreams;
        }
        ...
        if (typeof props.resolve_clients === 'boolean') {
            this._resolve_clients = props.resolve_clients;
        }
        ...
        if (typeof props.use_private_ptr_resolvers === 'boolean') {
            this._use_private_ptr_resolvers = props.use_private_ptr_resolvers;
        }
    }
    ...
    serialize(): IDNSConfig {
        ...
        if (typeof this._cache_optimistic !== 'undefined') {
            data.cache_optimistic = this._cache_optimistic;
        }
        ...
        if (typeof this._disable_ipv6 !== 'undefined') {
            data.disable_ipv6 = this._disable_ipv6;
        }
        ...
        if (typeof this._local_ptr_upstreams !== 'undefined') {
            data.local_ptr_upstreams = this._local_ptr_upstreams;
        }
        ...
        if (typeof this._resolve_clients !== 'undefined') {
            data.resolve_clients = this._resolve_clients;
        }
        ...
        if (typeof this._use_private_ptr_resolvers !== 'undefined') {
            data.use_private_ptr_resolvers = this._use_private_ptr_resolvers;
        }
        return data;
    }
    ...
    validate(): string[] {
        const validate = {
            ...
            disable_ipv6: !this._disable_ipv6 ? true : typeof this._disable_ipv6 === 'boolean',
            ...
            cache_optimistic: !this._cache_optimistic ? true : typeof this._cache_optimistic === 'boolean',
            use_private_ptr_resolvers: !this._use_private_ptr_resolvers ? true : typeof this._use_private_ptr_resolvers === 'boolean',
            resolve_clients: !this._resolve_clients ? true : typeof this._resolve_clients === 'boolean',
            local_ptr_upstreams: !this._local_ptr_upstreams ? true : this._local_ptr_upstreams.reduce((result, p) => result && typeof p === 'string', true),
        };
