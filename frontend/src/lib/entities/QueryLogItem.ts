...
import QueryLogItemClient, { IQueryLogItemClient } from './QueryLogItemClient';
...
export interface IQueryLogItem {
    ...
    client?: string;
    client_id?: string;
    client_info?: IQueryLogItemClient;
    client_proto?: any;
    elapsedMs?: string;
    filterId?: number;
...
export default class QueryLogItem {
    ...
    readonly _client_info: QueryLogItemClient | undefined;

    get clientInfo(): QueryLogItemClient | undefined {
    ...
    constructor(props: IQueryLogItem) {
        ...
        if (props.client_info) {
            this._client_info = new QueryLogItemClient(props.client_info);
        }
    ...
    serialize(): IQueryLogItem {
        ...
        if (typeof this._client_info !== 'undefined') {
            data.client_info = this._client_info.serialize();
        }
    ...
    validate(): string[] {
        const validate = {
            ...
            client_info: !this._client_info ? true : this._client_info.validate().length === 0,
