...
type Options struct {
	...
	HasherDriver              string        `yaml:"HasherDriver", json:"hasher_driver"`
	...
	ViewsLayout               string        `yaml:"ViewsLayout" json:"views_layout"`
	...
	SessionLookup             string        `yaml:"SessionLookup" json:"session_lookup"`
	SessionHost               string
	FiberViews                string
	SessionSecure             bool
	...
	FiberViewsLayout          string
	FiberViewsDelimsL         string
	FiberViewsDelimsR         string
	FiberViewsExtension       string
	FiberViewsDebug           bool
	FiberViewsReload          bool
	FiberViewsDirectory       string
	...
	HasherSaltLength          uint32
	HasherKeyLength           uint32
	SessionTableName          string
	SessionPassword           string
	HasherIterations          uint32
	HasherParallelism         uint8
	AccessLoggerType          string
	AccessLoggerEnabled       bool
	Environment               string
	AccessLoggerFilename      string
	AccessLoggerMaxsize       int
	AccessLoggerMaxAge        int
	AccessLoggerMaxBackups    int
	AccessLoggerLocalTime     bool
	AccessLoggerCompress      bool
	ForceHTTPS                bool
