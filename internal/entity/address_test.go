...
func TestAddress_String(t *testing.T) {
    t.Run("success", func(t *testing.T) {
        address := Address{ID: 1234567, AddressLine1: "Line 1", AddressLine2: "Line 2", AddressCity: "Beijing", AddressCountry: "CN"}
        addressString := address.String()
        assert.Equal(t, "Line 1,  Beijing, CN", addressString)
    })
}
