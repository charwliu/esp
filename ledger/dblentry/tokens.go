...
var ytokOpen = parsec.Atom("open", "DRTV_OPEN")
var ytokClose = parsec.Atom("close", "DRTV_CLOSE")
...
var ytokPushTag = parsec.Atom("pushtag", "DRTV_PUSHTAG")
var ytokPopTag = parsec.Atom("poptag", "DRTV_POPTAG")
var ytokPushMeta = parsec.Atom("pushmeta", "DRTV_PUSHMETA")
var ytokPopMeta = parsec.Atom("popmeta", "DRTV_POPMETA")
var ytokNote = parsec.Atom("note", "DRTV_NOTE")
var ytokDefault = parsec.Atom("default", "DRTV_DEFAULT")
var ytokOption = parsec.Atom("option", "DRTV_OPTION")
var ytokPlugin = parsec.Atom("plugin", "DRTV_PLUGIN")
var ytokDocument = parsec.Atom("document", "DRTV_DOCUMENT")
var ytokTxn = parsec.Atom("txn", "DRTV_TXN")
var ytokBalance = parsec.Atom("balance", "DRTV_BALANCE")
var ytokPad = parsec.Atom("pad", "DRTV_PAD")
var ytokDirtPrice = parsec.Atom("price", "DRTV_PRICE")
var ytokDirtQuery = parsec.Atom("query", "DRTV_QUERY")
var ytokDirtCustom = parsec.Atom("custom", "DRTV_CUSTOM")
